package com.zhapplication.model.detection;
...
public class TensorFlowImageClassifier2 implements Classifier {
     ...
     * @param inputSize_W H The input size. A square image of inputSize x inputSize is assumed.
    ...
    public static Classifier create(
        ...
        Log.i("Classifier", "Reading labels from: " + actualFilename);
        ...
        Log.i("Classifier", "operation.output(0).shape() " + operation.output(0).shape());
...
//    final int numClasses = (int) operation.output(0).shape().size(a);
        ...
        Log.i("Classifier", "Read " + c.labels.size() + " labels, output layer size is " + numClasses);
